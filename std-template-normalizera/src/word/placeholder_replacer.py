...
def replace_placeholders_using_config(docx_path, output_path=None):
    ...
    stx_number = config.get(ConfigKeys.STX_NUMBER, config.get(ConfigKeys.LEGACY_KEYS["STX_NUMBER"], ""))
    ...
    replacements = {
        ...
        WordPlaceholders.REPORT_NUMBER: config.get(ConfigKeys.REPORT_NUMBER, config.get(ConfigKeys.LEGACY_KEYS["REPORT_NUMBER"], "")),
